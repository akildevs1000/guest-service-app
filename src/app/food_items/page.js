            ...
            <nav className="bg-gray-100 dark:bg-[#111714]">
                <div className="flex border-b border-gray-300 dark:border-[#3d5245] px-4 gap-6 overflow-x-auto whitespace-nowrap">
                    {categories.map((cat) => (
                        <button
                            key={cat.id}
                            className={`flex flex-col items-center justify-center border-b-2 pb-3 pt-4 bg-transparent transition-colors ${selectedCategory === cat.id
                                ...
                                >
                                    ...
                                    {cart[item.id] ? (
                                        <div className="flex items-center justify-between gap-3 w-full">
                                            ...
                                            >
                                                <button
                                                    className="bg-green-900 text-white  text-xl rounded-xl w-10 h-10 flex items-center justify-center font-bold hover:bg-orange-600"
                                                ...
                                                <button
                                                    className="bg-green-900 text-white  text-xl rounded-xl w-10 h-10 flex items-center justify-center font-bold hover:bg-blue-600"
